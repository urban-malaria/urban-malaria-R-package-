...
.onAttach <- function(libname, pkgname) {
  packageStartupMessage(
    paste0(
      ...
      "Please specify Yes or No to indicate whether you would like to include settlement type and under-5 malaria tpr data\n",
      "in the composite score calculation.\n",
      "Please specify 1–4 reprioritization scenarios you would like to include (20, 30, 50, or 75 percent urban land cover)\n",
